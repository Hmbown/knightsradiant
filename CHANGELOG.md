...
### Added
- initial public repo structure for Knights Radiant as a Hermes profile + skill pack
- install entrypoint and profile installer
- artifact templates and example docs
- GitHub community files and basic CI
